...
export default function Home() {
  ...
  const [lastScrollY, setLastScrollY] = useState(0);
   ...
   // ⬇️ AGREGA ESTOS ESTADOS NUEVOS ⬇️
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await emailjs.send(
        'service_eeobkqj',      // ⚠️ REEMPLAZA con tu Service ID
        'template_csszygo',     // ⚠️ REEMPLAZA con tu Template ID
        {
        ...
        'BPDSXu5cQsLnn_Pn5'       // ⚠️ REEMPLAZA con tu Public Key
      );
...
<div data-aos="fade-up" className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-6xl mx-auto mt-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div data-aos="fade-right" className="bg-gradient-to-br from-red-700 via-red-600 to-red-800 rounded-3xl p-8 md:p-10 shadow-2xl transform hover:scale-[1.02] transition-transform duration-300">
              ...
              <p className="text-white/90 text-base leading-relaxed mb-10">
                En Red de Bodegas, nos encantará ayudarte a encontrar la solución de 
                ...
                una reserva, nuestro equipo de expertos están listos para atenderte. Estamos 
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <p className="text-white font-semibold break-all">contacto@redbodegasalas.cl</p>
                  </div>
                </div>
  ...
  <div>
    <input
      ...
      required
      disabled={loading}
      className="w-full px-5 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition backdrop-blur-sm disabled:opacity-50"
    />
  </div>
  ...
  <div>
    <textarea
      ...
      required
      disabled={loading}
      className="w-full px-5 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition resize-none backdrop-blur-sm disabled:opacity-50"
    ></textarea>
  </div>

  {/* Mensaje de éxito */}
  {success && (
    <div className="bg-green-500 text-white px-4 py-3 rounded-xl text-center animate-fade-in">
  ...
  <button
    type="submit"
    disabled={loading}
    className="w-full bg-gradient-to-r from-red-600 to-red-700 text-white font-bold py-4 px-8 rounded-xl hover:from-red-700 hover:to-red-800 transform hover:scale-[1.02] transition-all duration-200 shadow-lg hover:shadow-xl uppercase tracking-wide disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
  >
    {loading ? (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12 md:py-16">
      ...
      <div className="lg:col-span-1">
        ...
        <p className="text-blue-200 text-sm leading-relaxed mb-4">
          Soluciones integrales de almacenamiento con más de 6 años de experiencia. Seguridad, confiabilidad y servicio personalizado.
        </p>
        <div className="flex gap-3">
          ...
          <a href="mailto:contacto@redbodegasalas.cl" className="bg-white/10 hover:bg-red-600 p-2.5 rounded-full transition-all duration-300">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
              <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
            </svg>
        ...
        <ul className="space-y-3">
          ...
          <li className="flex items-start gap-3">
            ...
            <div>
              ...
              <a href="mailto:contacto@redbodegasalas.cl" className="text-white hover:text-red-400 transition-colors break-all">contacto@redbodegasalas.cl</a>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <svg className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
